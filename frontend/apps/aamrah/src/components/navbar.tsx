    ...
    >
      ...
      <nav className="container flex h-16 items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1">
          {[
            { href: "/search", icon: Search, label: "Search", show: true },
            { href: "/wishlist", icon: Heart, label: "Wishlist", show: false },
            { href: "/account", icon: User, label: "Account", show: false },
          ...
          <Magnetic strength={0.2}>
            ...
            >
              ...
              <motion.span
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                className="absolute -right-0.5 -top-0.5 flex h-[18px] min-w-[18px] items-center justify-center rounded-full bg-primary text-[10px] font-bold text-primary-foreground"
              >
                2
              </motion.span>
            </Link>
